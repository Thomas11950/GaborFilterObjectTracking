#Duplicate Gabor Filters don't duplicate vectors
...
class GaborFilters:
    ...
    class SetOfGroups:
        ...
        def determineGroupPositionAndMovementVector(self):
            ...
            for group in self.groups:
                totalRow += group[0][0] / numGroupsWithGaborIDs[group[3]]
                totalCol += group[0][1] / numGroupsWithGaborIDs[group[3]]
                totalRowVector += group[2][0] / numGroupsWithGaborIDs[group[3]]
                totalColVector += group[2][1] / numGroupsWithGaborIDs[group[3]]
            return [[totalRow/totalFiltersRepresented, totalCol/totalFiltersRepresented],[totalRowVector/totalFiltersRepresented,totalColVector/totalFiltersRepresented]]
