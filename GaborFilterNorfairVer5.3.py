#visualize groups by bounding box
...
for frame in video:
    ...
    for group in groupsToTrack:
        ...
        frameHistory[int(frameHistorySizeNeeded/2)] = cv2.rectangle(frameHistory[int(frameHistorySizeNeeded/2)], (int(group[0][1]), int(group[0][0])),(int(group[0][3]),int(group[0][2])),(255,255,255),2)
