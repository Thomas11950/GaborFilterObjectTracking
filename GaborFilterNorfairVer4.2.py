#Implements frame skipping for tracking objects of different speeds
...
gaborFilters = GaborFilters(gaborThreshold,groupSizeHeight,groupSizeWidth, 3, numAlternations)
for frame in video:
